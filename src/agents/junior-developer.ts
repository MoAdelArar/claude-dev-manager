...
export class JuniorDeveloperAgent extends BaseAgent {
  ...
  private synthesizeTests(task: AgentTask, sourceContent: string): string {
    ...
    lines.push('    // Arrange');
    lines.push(`    // TODO: Set up test data based on ${task.title}`);
    lines.push('');
    lines.push('    // Act');
    lines.push('    // TODO: Invoke the function/method under test');
    lines.push('');
    lines.push('    // Assert');
    lines.push('    // TODO: Verify the expected outcome');
    ...
    lines.push('    // Arrange');
    lines.push('    // TODO: Set up invalid input');
    lines.push('');
    lines.push('    // Act & Assert');
    lines.push('    // TODO: Verify error handling behavior');
    lines.push('    expect(true).toBe(true);');
    lines.push('  });');
    lines.push('');
